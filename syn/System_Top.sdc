...
# Created by write_sdc on Sat Oct 4 03:50:34 2025
...
create_clock [get_ports UART_CLK]  -period 271  -waveform {0 135.5}
...
create_generated_clock [get_pins ClkDiv_inst_RX/o_div_clk]  -name RX_CLK  -source [get_ports UART_CLK]  -master_clock UART_CLK  -divide_by 1  -add
...
create_generated_clock [get_pins ClkDiv_inst_TX/o_div_clk]  -name TX_CLK  -source [get_ports UART_CLK]  -master_clock UART_CLK  -divide_by 32  -add
...
set_input_delay -clock RX_CLK  54.2  [get_ports UART_RX_IN]
set_output_delay -clock TX_CLK  1734.4  [get_ports UART_TX_O]
set_output_delay -clock RX_CLK  54.2  [get_ports parity_error]
set_output_delay -clock RX_CLK  54.2  [get_ports framing_error]
